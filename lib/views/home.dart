      ...
      body: Stack(
        children: <Widget>[
          ...
          Container(
            ...
            padding: EdgeInsets.symmetric(vertical: !kIsWeb ? Platform.isIOS? 60: 30 : 30, horizontal: 10),
            child: Column(
              ...
              children: <Widget>[
                ...
                Text("Let's Cook!!",style: TextStyle(fontSize: 50,fontWeight: FontWeight.w800,fontStyle: FontStyle.italic,color: Colors.white),),
                SizedBox(
                  height: 20,
                ),
                Container(
                      ...
                      InkWell(
                          onTap: () async {
                            if (textEditingController.text.isNotEmpty) {
                              ...
                              recipies = [];
                              String url =
                                  "https://api.edamam.com/search?q=${textEditingController.text}&app_id={applicationID}&app_key={API KEY}";
                              ...
                              jsonData["hits"].forEach((element) {
                                ...
                                RecipeModel recipeModel = new RecipeModel(image: 'image', url: 'url', label: 'label', source: 'source');
                                recipeModel =
                  ...
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      minimumSize: Size.fromHeight(40),
                        backgroundColor: Color(0xff992e35),
                        elevation: 12.0,
                  ...
                  Container(
                    ...
                    child: IconButton(onPressed: (){setState(() {
                      if(_iconColor==Colors.black){
                        ...
                        recpie.add(RecipeModel(image: "image", url: "url", label: "label", source: "source"));
                      }else
                      {
                        _iconColor=Colors.black;
                        recpie.remove(RecipeModel(image: "image", url: "url", label: "label", source: "source"));
                      }
